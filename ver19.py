...
# use train as test to determine best p

# 0.88646

train_dir_name = '/Users/NoSlack/kaggle_planet/train-jpg/'
test_dir_name = '/Users/NoSlack/kaggle_planet/test-jpg/'
N = 40479 #40479
V = 2000 # < M
M = 61191 #61191
...
# x_transform
x_train_transform = np.zeros((N,512,4,4))
...
model_train.add(Dense(512, activation='relu'))
...
# x_test_transform
x_test_transform = np.zeros((M,512,4,4))
...
# data_to_predict = x_train_transform
p_test = model_train.predict(data_to_predict, batch_size=128)
with open('p_test_from_x_test_transform_ver19', 'w') as f:
    np.save(f, p_test)
